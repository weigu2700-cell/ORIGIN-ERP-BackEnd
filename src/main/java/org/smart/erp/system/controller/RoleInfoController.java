...
public class RoleInfoController {
    ...
    @GetMapping("/list")
    public Result<Page<RoleInfoVo>> pageRole(RoleDetailDto dto) {
        return Result.success(roleInfoService.pageRole(dto));
    }

    @Operation(summary = "角色详情")
    @GetMapping("/{id}")
    public Result<RoleInfoVo> detailRole(@PathVariable Long id) {
        return Result.success(roleInfoService.detailRole(id));
    }
