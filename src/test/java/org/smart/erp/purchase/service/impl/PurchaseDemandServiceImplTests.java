...
class PurchaseDemandServiceImplTests {
	...
	@BeforeEach
	void setUp() {
		service = new PurchaseDemandServiceImpl(purchaseDemandMapper, businessNoGenerator, notificationPublisher);
	}
	...
	void addPublishesPendingApprovalNotificationAfterInsert() {
		...
		assertThat(captor.getValue().getRecipients().getPermissionCodes()).containsExactly("purchase:demand:approve");
